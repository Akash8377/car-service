        ...
        <div>
            ...
            <div className='termCondition-main'>
                ...
                <p className='termcondition-paragraph-1'>You must create an account in order to use some of the features offered by the Platform. Use of any personal information you provide to us during the account creation process is governed by our Privacy Policy available on our app/website. You must keep your password confidential and you are solely responsible for maintaining the confidentiality and security of your account details, all changes and updates submitted through your account, and all activities that occur in connection with your account.
                    ...
                    You must only book a Service if you have a genuine requirement for the work detailed to be performed. You must only post feedback in relation to a service provider if you have availed Service from them as a result of your use of the Platform.</p>

                <h4 className='termcondition-heading-2'>SUPPORT</h4>
                <p className='termcondition-paragraph-1'>The Company offers an email as well as phone call based support system along with an online knowledge pool of FAQs. In case you require any assistance or support, you may access support resources or contact our support by emailing at info@gomechanic.in or calling our helpline at +91-8398970970 (Monday to Sunday between 7 am and 9 pm).
...
//     const createOrUpdateTerms = async (newTerms) => {
//         try {
//             const response = await axios.post('https://kv-varlu.vercel.app/api/v1/terms', {
//                 terms: newTerms,
//             });
//             console.log('Terms created/updated successfully:', response.data);
//         } catch (error) {
...
//         try {
//             await axios.delete('https://kv-varlu.vercel.app/api/v1/terms/64d23f861d57643385270ecd');
