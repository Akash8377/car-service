    ...
    return (
        <div>
            ...
            <div className='periodic-service-main'>
                <h2 className='periodic-service-main-heading'>Polishing</h2>
                ...
                <div className='inner-service-main'>
                    ...
                    />
                    <div>
                        <h3>3M™ Car Rubbing & Polishing</h3>
                        <h5 className='periodic-text-1'> • Every 5 Months ( Recommended ) </h5>
            ...
            <div className='periodic-service-main'>
            <h2 className='periodic-service-main-heading'>Ceramic Coating</h2>
                <p className='periodic-service-main-paragraph'>
                    <img src={image42} alt="" height="20px" width="20px" />4 Hrs Taken</p>
            ...
            <div className='periodic-service-main'>
            <h2 className='periodic-service-main-heading'>Teflon Coating</h2>
                <p className='periodic-service-main-paragraph'>
                    <img src={image42} alt="" height="20px" width="20px" />4 Hrs Taken</p>
            ...
            <div className='periodic-service-main'>
                ...
                <div className='inner-service-main'>
                    ...
                    />
                    <div>
                        <h3>Meguiar's Teflon Coating</h3>
                        <h5 className='periodic-text-1'>•3 Years Warranty on Paint</h5>
                        <div className='periodic-text-2-main'>
                            <div className='periodic-text-2'>
                                <img src={image43} alt="" /> Wiper Fluid Replacement
            ...
            <div className='periodic-service-main'>
            <h2 className='periodic-service-main-heading'>PPF</h2>
                <p className='periodic-service-main-paragraph'>
                    <img src={image42} alt="" height="20px" width="20px" />4 Hrs Taken</p>
